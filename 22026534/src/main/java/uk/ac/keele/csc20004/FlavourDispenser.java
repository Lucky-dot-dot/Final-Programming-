...
import uk.ac.keele.csc20004.cakes.Flavour;

/**
 * A concrete implementation of a dispenser; in this case, for filling. 
 *
 * @see Dispenser
 * 
 * @author marcoortolani
 */
public class FlavourDispenser extends Dispenser<Flavour> {
     ...
     */
    public FlavourDispenser(int capacity) {
        super(capacity);
    }
     ...
     */
    @Override
    protected Flavour createIngredient() {
        return new Flavour();
    }
}
